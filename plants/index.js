...
console.log('Картинки обрезаны не по макету, это специально! Для лучшего адаптива взяты hires-изображения и адаптируются в css.\n' + 
'Меню занимает весь вьюпорт, его внешний на свое усмотрение\n' + '\n' +
 '1. Верстка соответствует макету. Ширина экрана 768px +24\n' +
...
'4. На ширине экрана 380рх и меньше реализовано адаптивное меню +22\n' +
 ...
 '! Меню занимает весь вьюпорт, поэтому не скрывается по клике на пустом месте (его внешний вид на свое усмотрение) +4\n' +
 'Самооценка: 75/75');